...
interface PathInputProps {
  onFetch: (path: string, format: string) => void;
  initialPath?: string;
}
...
const FORMAT_OPTIONS = ["Iceberg", "Delta", "Hudi"];
        ...
        <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-2">
          ...
          <div className="flex space-x-2 items-center">
            <div className="flex items-center">
              <label htmlFor="format" className="text-sm font-medium text-neutral-600 mr-2">Format:</label>
              <select
                id="format"
                value={format}
